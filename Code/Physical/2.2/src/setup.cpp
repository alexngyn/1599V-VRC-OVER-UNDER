...
lemlib::TrackingWheel tracking_wheel(&tracking_encoder, 2.75, 0); // 2.75" wheel diameter, -4.6" offset from tracking center
...
lemlib::OdomSensors sensors {
    &tracking_wheel, // vertical tracking wheel 1, set to nullptr as we don't have one
