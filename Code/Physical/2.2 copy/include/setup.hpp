...
#define WING_L_SOLENOID_PORT 'D'
#define WING_R_SOLENOID_PORT 'H'
#define BLOCKER_SOLENOID_PORT 'G'
#define BLOCKER_ENABLE_SOLENOID_PORT 'B'
#define ENCODER_PORT_1 'C'
#define ENCODER_PORT_2 'D'
...
extern pros::ADIDigitalOut wing_left_solenoid;
extern pros::ADIDigitalOut wing_right_solenoid;
extern pros::ADIDigitalOut blocker_solenoid;
extern pros::ADIDigitalOut blocker_enable_solenoid;
