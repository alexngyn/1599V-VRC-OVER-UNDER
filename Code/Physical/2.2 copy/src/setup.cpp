...
pros::ADIDigitalOut blocker_enable_solenoid (BLOCKER_ENABLE_SOLENOID_PORT);

pros::ADIEncoder tracking_encoder(ENCODER_PORT_1, ENCODER_PORT_2, true); // ports A and B, reversed
...
lemlib::TrackingWheel tracking_wheel(&tracking_encoder, 2.75, 0); // 2.75" wheel diameter, -0" offset from tracking center
...
lemlib::OdomSensors sensors {
    &tracking_wheel, // vertical tracking wheel 1
