...
vex::motor       front_left_motor   = vex::motor(vex::PORT8, vex::gearSetting::ratio6_1, false);
vex::motor       middle_left_motor  = vex::motor(vex::PORT9, vex::gearSetting::ratio6_1, false);
